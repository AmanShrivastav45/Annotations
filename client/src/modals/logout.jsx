  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none">
      <div className="relative w-auto mx-auto max-w-sm">
        {/* Content */}
        <div className="border-0 rounded-lg shadow-xl relative flex flex-col w-full bg-[#09090b] outline-none focus:outline-none">
          {/* Header */}
          <div className="Geist-semibold flex items-start justify-between p-4 pb-2 border-b border-solid border-[2a2a2a] rounded-t">
