...
const DeleteNote = ({ onDeleteNote, onCancel }) => {
  return (
    <div style={{ zIndex: 1000 }} className="fixed inset-0 z-50 bg-[black] bg-opacity-75 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none">
      <div className="relative w-auto mx-auto  max-w-sm">
        ...
        <div className="border-0 rounded-lg shadow-xl relative px-2 flex flex-col w-full bg-[#1e1e1e] outline-none focus:outline-none">
          ...
          <div className="Geist flex items-start justify-between p-4 pb-0 rounded-t">
            <h3 className="text-xl text-gray-300">Delete</h3>
            <button
              className=" bg-transparent border-0 text-3xl leading-none font-semibold outline-none focus:outline-none"
              onClick={onCancel}
            >
